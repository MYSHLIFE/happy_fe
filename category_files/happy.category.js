...
publicLib.leftPanel();
    $("body").on("click", ".tag_p2", function(event) {
        ...
        }).on("click",".category_row",function(event){
            event.preventDefault();
            var type = $(this).data("type");
            switch(type){
                case "A" :
                    window.location.href="/activity/publish";
                    break;
                case "B":
                     window.location.href="/activity/publish_b";
                    break;
                case "C":
                     window.location.href="/activity/publish_c";
                    break;
            }
        })
